...
class UseHttp {
  ...
  public function __construct(){
	$url = 'http://xueqiu.com/P/ZH016293';
  ...
  */
  ...
  private function makeFile($path) {
	...
	function curl_test($http){
		$response = $http->call('http://xueqiu.com/cubes/quote.json','GET',array('code'=>'ZH002754'));
		$arr = json_decode($response,TRUE);
		file_put_contents('/alidata/www/phpwind/gy/test_connect.txt',print_r($arr,true));
	}
/* 
